    ...
    <section id="skills" className="py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="absolute inset-28 sm:inset-36 md:inset-44 border-[1px] border-dashed border-white/30 rounded-full" style={{ animation: 'spin 35s linear infinite' }}>
            {/* 0 deg */}
          ...
          <div className="absolute inset-14 sm:inset-18 md:inset-22 border-[1px] border-dashed border-white/30 rounded-full" style={{ animation: 'spin 50s linear infinite reverse' }}>
            {/* 0 deg */}
            <div className="absolute top-[0%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
          ...
          <div className="absolute inset-0 sm:inset-0 md:inset-0 border-[1px] border-dashed border-white/30 rounded-full" style={{ animation: 'spin 65s linear infinite' }}>
            ...
            <div className="absolute top-[0%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
                 ...
                 <div className="relative w-full h-full bg-[#0a0a0a] border border-white/10 rounded-full flex items-center justify-center z-10 group-hover:bg-[#121212] transition-colors">
                   <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/c/c-original.svg" alt="C" className="w-7 h-7" />
                 </div>
               </div>
            </div>
            {/* 45 deg */}
            <div className="absolute top-[14.6%] left-[85.4%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
            ...
            {/* 90 deg */}
            <div className="absolute top-[50%] left-[100%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
            ...
            {/* 135 deg */}
            <div className="absolute top-[85.4%] left-[85.4%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
                 <div className="absolute inset-0 bg-gradient-to-tr from-blue-500 to-transparent opacity-50 group-hover:opacity-100 animate-[spin_4s_linear_infinite]" />
                 <div className="relative w-full h-full bg-[#0a0a0a] border border-white/10 rounded-full flex items-center justify-center z-10 group-hover:bg-[#121212] transition-colors">
            ...
            <div className="absolute top-[100%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
                 ...
                 <div className="relative w-full h-full bg-[#0a0a0a] border border-white/10 rounded-full flex items-center justify-center z-10 group-hover:bg-[#121212] transition-colors">
                   <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" alt="Bootstrap" className="w-7 h-7" />
                 </div>
               </div>
            </div>
            {/* 225 deg */}
            <div className="absolute top-[85.4%] left-[14.6%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
                 ...
                 <div className="relative w-full h-full bg-[#0a0a0a] border border-white/10 rounded-full flex items-center justify-center z-10 group-hover:bg-[#121212] transition-colors">
                   <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg" alt="Express" className="w-7 h-7 invert" />
                 </div>
               </div>
            </div>
            {/* 270 deg */}
            <div className="absolute top-[50%] left-[0%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
                 <div className="absolute inset-0 bg-gradient-to-tr from-blue-500 to-transparent opacity-50 group-hover:opacity-100 animate-[spin_4s_linear_infinite]" />
                 <div className="relative w-full h-full bg-[#0a0a0a] border border-white/10 rounded-full flex items-center justify-center z-10 group-hover:bg-[#121212] transition-colors">
            ...
            {/* 315 deg */}
            <div className="absolute top-[14.6%] left-[14.6%] -translate-x-1/2 -translate-y-1/2 w-14 h-14">
               <div className="relative w-full h-full rounded-full flex items-center justify-center p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] transition-all duration-300" style={{ animation: 'spin 65s linear infinite reverse' }}>
